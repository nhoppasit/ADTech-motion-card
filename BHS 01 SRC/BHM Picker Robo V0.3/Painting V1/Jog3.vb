...
Public Class Jog3
    ...
    Shared mAxis As Integer = 3

    Private Shared JogRange_physical As Double = My.Settings.ZJogRange
    Private Shared JogRange As Long = JogRange_physical * My.Settings.Zppmm_Numerator / My.Settings.Zppmm_Denominator
    Private Shared JogSpeed As Long = My.Settings.ZJogSpeed
    Private Shared TAcc As Double = My.Settings.ZJogDt
    ...
    Public Shared Sub Setup(ByVal range As Double, ByVal speed As Long, ByVal dt As Double)
        ...
        JogRange = JogRange_physical * My.Settings.Zppmm_Numerator / My.Settings.Zppmm_Denominator
        JogSpeed = speed
        TAcc = dt
    End Sub
