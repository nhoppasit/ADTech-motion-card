...
Public Class Jog1
    ...
    Shared mAxis As Integer = 1

    Private Shared JogRange_physical As Double = My.Settings.XJogRange
    Private Shared JogRange As Long = JogRange_physical * My.Settings.Xppmm_Numerator / My.Settings.Xppmm_Denominator
    Private Shared JogSpeed As Long = My.Settings.XJogSpeed
    Private Shared TAcc As Double = My.Settings.XJogDt
    ...
    Public Shared Sub Setup(ByVal range As Double, ByVal speed As Long, ByVal dt As Double)
        ...
        JogRange = JogRange_physical * My.Settings.Xppmm_Numerator / My.Settings.Xppmm_Denominator
        JogSpeed = speed
        TAcc = dt
    End Sub
